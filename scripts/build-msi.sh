...
XML_FILE+="        <Property Id='INSTALLLEVEL' Value='2' />\r\n"
...
XML_FILE+="\r\n"
XML_FILE+="            <Dialog Id='WarningDialog' Width='370' Height='270' Title='!(loc.InstallDirDlg_Title)'>\r\n"
...
XML_FILE+="                </Control>\r\n"
XML_FILE+="                <Control Id='Description' Type='Text' X='25' Y='23' Width='280' Height='15' Transparent='yes' NoPrefix='yes' Text='Use at your own risk' />\r\n"
XML_FILE+="                <Control Id='Title' Type='Text' X='15' Y='6' Width='200' Height='15' Transparent='yes' NoPrefix='yes' Text='WARNING!' />\r\n"
...
XML_FILE+="                </Control>\r\n"
XML_FILE+="                <Control Id='TypicalText' Type='Text' X='40' Y='140' Width='300' Height='40' Text='Installing OpenRGB without registering as a system service means nothing runs automatically in the background by default.  Accessing devices through PawnIO will require running OpenRGB as administrator.' />\r\n"
...
XML_FILE+="            </Dialog>\r\n"
XML_FILE+="\r\n"
XML_FILE+="            <Publish Dialog='InstallDirDlg' Control='Next' Event='NewDialog' Value='WarningDialog' Order='5'>WIXUI_DONTVALIDATEPATH OR WIXUI_INSTALLDIR_VALID=\"1\"</Publish>\r\n"
XML_FILE+="            <Publish Dialog='VerifyReadyDlg' Control='Back' Event='NewDialog' Value='ServiceDialog' Order='2'>1</Publish>\r\n"
XML_FILE+="            <Publish Dialog='WarningDialog' Control='Next' Event='NewDialog' Value='PawnIODialog' Order='2'>1</Publish>\r\n"
XML_FILE+="            <Publish Dialog='WarningDialog' Control='Back' Event='NewDialog' Value='InstallDirDlg' Order='2'>1</Publish>\r\n"
XML_FILE+="            <Publish Dialog='PawnIODialog' Control='Next' Event='NewDialog' Value='ServiceDialog' Order='2'>1</Publish>\r\n"
XML_FILE+="            <Publish Dialog='PawnIODialog' Control='Back' Event='NewDialog' Value='WarningDialog' Order='2'>1</Publish>\r\n"
