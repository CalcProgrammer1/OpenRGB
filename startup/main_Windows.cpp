...
\*---------------------------------------------------------*/
static void ServiceDetectionCallback(void *, unsigned int update_reason)
{
...
static int common_main(int argc, char* argv[])
{
    ...
    if(started_as_service)
    {
        ResourceManager::get()->RegisterDetectionCallback(ServiceDetectionCallback, NULL);
    }
    ...
    if(started_as_service)
    {
        ResourceManager::get()->UnregisterDetectionCallback(ServiceDetectionCallback, NULL);
    }
