...
keyboard_keymap_overlay iso_azerty
{
    KEYBOARD_SIZE_FULL,
    {
        ...
        |   Zone,   Row,    Column,     Value,      Name,                       Translated Name,            OpCode                              |
        \*-------------------------------------------------------------------------------------------------------------------------------------*/
        {   0,      3,      12,         0,          KEY_EN_UNUSED,              KEY_FR_ASTERIX,             KEYBOARD_OPCODE_ADD_TRANSLATION,    },
        {   0,      4,      1,          0,          KEY_EN_UNUSED,              KEY_NORD_ANGLE_BRACKET,     KEYBOARD_OPCODE_ADD_TRANSLATION,    },
        {   0,      1,      0,          0,          KEY_EN_UNUSED,              KEY_FR_SUPER_2,             KEYBOARD_OPCODE_ADD_TRANSLATION,    },
        {   0,      1,      1,          0,          KEY_EN_UNUSED,              KEY_FR_AMPERSAND,           KEYBOARD_OPCODE_ADD_TRANSLATION,    },
        {   0,      1,      2,          0,          KEY_EN_UNUSED,              KEY_FR_ACUTE_E,             KEYBOARD_OPCODE_ADD_TRANSLATION,    },
        {   0,      1,      3,          0,          KEY_EN_UNUSED,              KEY_FR_DOUBLEQUOTE,         KEYBOARD_OPCODE_ADD_TRANSLATION,    },
        {   0,      1,      4,          0,          KEY_EN_UNUSED,              KEY_EN_QUOTE,               KEYBOARD_OPCODE_ADD_TRANSLATION,    },
        {   0,      1,      5,          0,          KEY_EN_UNUSED,              KEY_FR_LEFT_PARENTHESIS,    KEYBOARD_OPCODE_ADD_TRANSLATION,    },
        {   0,      1,      6,          0,          KEY_EN_UNUSED,              KEY_EN_MINUS,               KEYBOARD_OPCODE_ADD_TRANSLATION,    },
        {   0,      1,      7,          0,          KEY_EN_UNUSED,              KEY_FR_GRAVE_E,             KEYBOARD_OPCODE_ADD_TRANSLATION,    },
        {   0,      1,      8,          0,          KEY_EN_UNUSED,              KEY_FR_UNDERSCORE,          KEYBOARD_OPCODE_ADD_TRANSLATION,    },
        {   0,      1,      9,          0,          KEY_EN_UNUSED,              KEY_FR_CEDILLA_C,           KEYBOARD_OPCODE_ADD_TRANSLATION,    },
        {   0,      1,      10,         0,          KEY_EN_UNUSED,              KEY_FR_GRAVE_A,             KEYBOARD_OPCODE_ADD_TRANSLATION,    },
        {   0,      1,      11,         0,          KEY_EN_UNUSED,              KEY_FR_RIGHT_PARENTHESIS,   KEYBOARD_OPCODE_ADD_TRANSLATION,    },
        {   0,      2,      1,          0,          KEY_EN_UNUSED,              KEY_EN_A,                   KEYBOARD_OPCODE_ADD_TRANSLATION,    },
        {   0,      2,      2,          0,          KEY_EN_UNUSED,              KEY_EN_Z,                   KEYBOARD_OPCODE_ADD_TRANSLATION,    },
        {   0,      2,      11,         0,          KEY_EN_UNUSED,              KEY_JP_CHEVRON,             KEYBOARD_OPCODE_ADD_TRANSLATION,    },
        {   0,      2,      12,         0,          KEY_EN_UNUSED,              KEY_FR_DOLLAR,              KEYBOARD_OPCODE_ADD_TRANSLATION,    },
        {   0,      2,      13,         0,          KEY_EN_UNUSED,              KEY_EN_UNUSED,              KEYBOARD_OPCODE_ADD_TRANSLATION,    },
        {   0,      3,      1,          0,          KEY_EN_UNUSED,              KEY_EN_Q,                   KEYBOARD_OPCODE_ADD_TRANSLATION,    },
        {   0,      3,      10,         0,          KEY_EN_UNUSED,              KEY_EN_M,                   KEYBOARD_OPCODE_ADD_TRANSLATION,    },
        {   0,      3,      11,         0,          KEY_EN_UNUSED,              KEY_FR_GRAVE_U,             KEYBOARD_OPCODE_ADD_TRANSLATION,    },
        {   0,      4,      2,          0,          KEY_EN_UNUSED,              KEY_EN_W,                   KEYBOARD_OPCODE_ADD_TRANSLATION,    },
        {   0,      4,      8,          0,          KEY_EN_UNUSED,              KEY_EN_COMMA,               KEYBOARD_OPCODE_ADD_TRANSLATION,    },
        {   0,      4,      9,          0,          KEY_EN_UNUSED,              KEY_EN_SEMICOLON,           KEYBOARD_OPCODE_ADD_TRANSLATION,    },
        {   0,      4,      10,         0,          KEY_EN_UNUSED,              KEY_JP_COLON,               KEYBOARD_OPCODE_ADD_TRANSLATION,    },
        {   0,      4,      11,         0,          KEY_EN_UNUSED,              KEY_FR_EXCLAIMATION,        KEYBOARD_OPCODE_ADD_TRANSLATION,    },
    }
};
...
keyboard_keymap_overlay iso_qwertz
{
    KEYBOARD_SIZE_FULL,
    {
        ...
        |   Zone,   Row,    Column,     Value,      Name,                       Translated Name,            OpCode                              |
        \*-------------------------------------------------------------------------------------------------------------------------------------*/
        {   0,      3,      12,         0,          KEY_EN_UNUSED,              KEY_EN_POUND,               KEYBOARD_OPCODE_ADD_TRANSLATION,    },
        {   0,      4,      1,          0,          KEY_EN_UNUSED,              KEY_NORD_ANGLE_BRACKET,     KEYBOARD_OPCODE_ADD_TRANSLATION,    },
        {   0,      1,      0,          0,          KEY_EN_UNUSED,              KEY_JP_CHEVRON,             KEYBOARD_OPCODE_ADD_TRANSLATION,    },
        {   0,      1,      11,         0,          KEY_EN_UNUSED,              KEY_DE_ESZETT,              KEYBOARD_OPCODE_ADD_TRANSLATION,    },
        {   0,      1,      12,         0,          KEY_EN_UNUSED,              KEY_EN_BACK_TICK,           KEYBOARD_OPCODE_ADD_TRANSLATION,    },
        {   0,      2,      6,          0,          KEY_EN_UNUSED,              KEY_EN_Z,                   KEYBOARD_OPCODE_ADD_TRANSLATION,    },
        {   0,      2,      11,         0,          KEY_EN_UNUSED,              KEY_DE_DIAERESIS_U,         KEYBOARD_OPCODE_ADD_TRANSLATION,    },
        {   0,      2,      12,         0,          KEY_EN_UNUSED,              KEY_EN_PLUS,                KEYBOARD_OPCODE_ADD_TRANSLATION,    },
        {   0,      2,      13,         0,          KEY_EN_UNUSED,              KEY_EN_UNUSED,              KEYBOARD_OPCODE_ADD_TRANSLATION,    },
        {   0,      3,      10,         0,          KEY_EN_UNUSED,              KEY_DE_DIAERESIS_O,         KEYBOARD_OPCODE_ADD_TRANSLATION,    },
        {   0,      3,      11,         0,          KEY_EN_UNUSED,              KEY_DE_DIAERESIS_A,         KEYBOARD_OPCODE_ADD_TRANSLATION,    },
        {   0,      4,      2,          0,          KEY_EN_UNUSED,              KEY_EN_Y,                   KEYBOARD_OPCODE_ADD_TRANSLATION,    },
        {   0,      4,      11,         0,          KEY_EN_UNUSED,              KEY_EN_MINUS,               KEYBOARD_OPCODE_ADD_TRANSLATION,    },
    }
};
...
keyboard_keymap_overlay jis
{
    KEYBOARD_SIZE_FULL,
    {
        ...
        |   Zone,   Row,    Column,     Value,      Name,                       Translated Name,            OpCode                              |
        \*-------------------------------------------------------------------------------------------------------------------------------------*/
        {   0,      3,      12,         0,          KEY_EN_RIGHT_BRACKET,       KEY_EN_UNUSED,              KEYBOARD_OPCODE_ADD_TRANSLATION,    },
        {   0,      4,      12,         0,          KEY_EN_BACK_SLASH,          KEY_EN_UNUSED,              KEYBOARD_OPCODE_ADD_TRANSLATION,    },
        {   0,      1,      12,         0,          KEY_JP_CHEVRON,             KEY_EN_UNUSED,              KEYBOARD_OPCODE_ADD_TRANSLATION,    },
        {   0,      2,      11,         0,          KEY_JP_AT,                  KEY_EN_UNUSED,              KEYBOARD_OPCODE_ADD_TRANSLATION,    },
        {   0,      2,      12,         0,          KEY_EN_LEFT_BRACKET,        KEY_EN_UNUSED,              KEYBOARD_OPCODE_ADD_TRANSLATION,    },
        {   0,      3,      11,         0,          KEY_JP_COLON,               KEY_EN_UNUSED,              KEYBOARD_OPCODE_ADD_TRANSLATION,    },
        {   0,      2,      13,         0,          KEY_EN_UNUSED,              KEY_EN_UNUSED,              KEYBOARD_OPCODE_ADD_TRANSLATION,    },
    }
};
...
void KeyboardLayoutManager::OpCodeSwitch(key_set change_keys)
{
    ...
    for(size_t chg_key_idx = 0; chg_key_idx < change_keys.size(); chg_key_idx++)
    {
        switch(change_keys[chg_key_idx].opcode)
        {
            ...
            case KEYBOARD_OPCODE_ADD_TRANSLATION:
                AddTranslation(change_keys[chg_key_idx]);
                break;
...
void KeyboardLayoutManager::AddTranslation(keyboard_led key)
{
    /*---------------------------------------------------------------------*\
    | Get the edit point                                                    |
    \*---------------------------------------------------------------------*/
    ...
    const char*     edit_translated_name = key.translated_name;
    ...
    for(unsigned int key_idx = 0; key_idx < keymap.size(); key_idx++)
    {
        ...
        if((edit_row == keymap[key_idx].row) && (edit_col == keymap[key_idx].col))
        {
            ...
            \*---------------------------------------------------------------------*/
            LOG_DEBUG("[%s] Adding translation %s to %s @ %02d, %02d", KLM_CLASS_NAME, edit_translated_name, keymap[key_idx].name, keymap[key_idx].row, keymap[key_idx].col);
            keymap[key_idx].translated_name = edit_translated_name;
            break;
        }
    }
}
...
std::string KeyboardLayoutManager::GetTranslatedKeyNameAt(unsigned int key_idx)
{
    if(key_idx < keymap.size())
    {
        return keymap[key_idx].translated_name;
    }

    return KEY_EN_UNUSED;
}

std::string KeyboardLayoutManager::GetTranslatedKeyNameAt(unsigned int row, unsigned int col)
{
    for(std::vector<keyboard_led>::iterator key = keymap.begin(); key != keymap.end(); ++key)
    {
        if(key->row == row && key->col == col)
        {
            return key->translated_name;
        }
    }
