...
enum KEYBOARD_OPCODE
{
    ...
    KEYBOARD_OPCODE_ADD_TRANSLATION     = 6,
};
...
public:
    ...
    std::string                 GetTranslatedKeyNameAt(unsigned int key_idx);
    std::string                 GetTranslatedKeyNameAt(unsigned int row, unsigned int col);
...
private:
    ...
    void                        AddTranslation(keyboard_led key);
