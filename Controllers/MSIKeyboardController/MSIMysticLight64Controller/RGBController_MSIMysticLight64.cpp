...
RGBController_MSIMysticLight64::RGBController_MSIMysticLight64(MSIMysticLight64Controller *controller_ptr)
{
...
void RGBController_MSIMysticLight64::DeviceUpdateLEDs()
{
    ...
    MSI_64_SPEED        speed       = (MSI_64_SPEED)Mode.speed;
    MSI_64_BRIGHTNESS   brightness  = (MSI_64_BRIGHTNESS)(Mode.brightness);
...
void RGBController_MSIMysticLight64::SetupMode(const char *name, MSI_64_MODE mod, unsigned int flags)
{
    mode Mode;
    ...
    {
        Mode.brightness_min = MSI_64_BRIGHTNESS_LEVEL_10;
        Mode.brightness_max = MSI_64_BRIGHTNESS_LEVEL_100;
        Mode.brightness     = MSI_64_BRIGHTNESS_LEVEL_100;
    }
    if(flags & MODE_FLAG_HAS_SPEED)
    {
        Mode.speed_min      = MSI_64_SPEED_LOW;
        Mode.speed_max      = MSI_64_SPEED_HIGH;
        Mode.speed          = MSI_64_SPEED_LOW;
    }
