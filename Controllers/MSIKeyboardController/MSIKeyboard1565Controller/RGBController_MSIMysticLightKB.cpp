/*---------------------------------------------------------*\
| RGBController_MSIKeyboard1565.cpp                         |
|                                                           |
...
RGBController_MSIKeyboard1565::RGBController_MSIKeyboard1565(MSIKeyboard1565Controller *controller_ptr)
{
    controller  = controller_ptr;
    name        = controller->GetDeviceName();
    vendor      = "MSI";
    type        = DEVICE_TYPE_KEYBOARD;
    description = "MSI Mystic Light MS-1565 Keyboard Device";
...
RGBController_MSIKeyboard1565::~RGBController_MSIKeyboard1565()
{
    Shutdown();
...
void RGBController_MSIKeyboard1565::SetupZones()
{
}

void RGBController_MSIKeyboard1565::DeviceUpdateMode()
{
    DeviceUpdateLEDs();
}

void RGBController_MSIKeyboard1565::DeviceUpdateLEDs()
{
...
void RGBController_MSIKeyboard1565::DeviceUpdateZoneLEDs(int /*zone*/)
{
}

void RGBController_MSIKeyboard1565::DeviceUpdateSingleLED(int /*led*/)
{
}

void RGBController_MSIKeyboard1565::SetupModes()
{
...
void RGBController_MSIKeyboard1565::SetupMode
(
...
void RGBController_MSIKeyboard1565::SetupZonesMode
(
    const std::string name,
    MS_1565_MODE mod,
    unsigned int flags
