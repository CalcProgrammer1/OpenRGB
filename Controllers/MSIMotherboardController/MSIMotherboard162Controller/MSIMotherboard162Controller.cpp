/*---------------------------------------------------------*\
| MSIMotherboard162Controller.cpp                           |
|                                                           |
...
MSIMotherboard162Controller::MSIMotherboard162Controller(hid_device* handle, const char* path, unsigned short pid, std::string dev_name)
{
    dev         = handle;
    location    = path;
    name        = dev_name;
...
MSIMotherboard162Controller::~MSIMotherboard162Controller()
{
    hid_close(dev);
}

void MSIMotherboard162Controller::SetMode
    (
    MSI_ZONE        zone,
    MSI_MODE        mode,
    MSI_SPEED       speed,
...
std::string MSIMotherboard162Controller::GetDeviceName()
{
    return name;
}

std::string MSIMotherboard162Controller::GetFWVersion()
{
...
std::string MSIMotherboard162Controller::GetDeviceLocation()
{
    return("HID: " + location);
}

std::string MSIMotherboard162Controller::GetSerial()
{
...
bool MSIMotherboard162Controller::ReadSettings()
{
    /*-----------------------------------------------------*\
...
bool MSIMotherboard162Controller::Update
    (
    bool save
    )
{
...
void MSIMotherboard162Controller::SetZoneColor
    (
    MSI_ZONE        zone,
    unsigned char   red1,
    unsigned char   grn1,
...
ZoneData *MSIMotherboard162Controller::GetZoneData
    (
...
bool MSIMotherboard162Controller::ReadFwVersion()
{
...
MSI_MODE MSIMotherboard162Controller::GetMode()
{
    return (MSI_MODE)data.on_board_led.effect;
}

void MSIMotherboard162Controller::GetMode
    (
    MSI_ZONE        zone,
    MSI_MODE        &mode,
    MSI_SPEED       &speed,
...
size_t MSIMotherboard162Controller::GetMaxOnboardLeds()
{
