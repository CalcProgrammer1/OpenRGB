/*---------------------------------------------------------*\
| RGBController_MSIMotherboard162.cpp                       |
|                                                           |
...
RGBController_MSIMotherboard162::RGBController_MSIMotherboard162(MSIMotherboard162Controller* controller_ptr)
{
...
RGBController_MSIMotherboard162::~RGBController_MSIMotherboard162()
{
    Shutdown();
...
int RGBController_MSIMotherboard162::GetDeviceMode()
{
...
void RGBController_MSIMotherboard162::SetupZones()
{
    /*-----------------------------------------------------*\
    | Set up zones                                          |
    \*-----------------------------------------------------*/
...
void RGBController_MSIMotherboard162::DeviceUpdateLEDs()
{
...
void RGBController_MSIMotherboard162::DeviceUpdateZoneLEDs
    (
    int zone
    )
{
...
void RGBController_MSIMotherboard162::DeviceUpdateSingleLED
    (
    int led
    )
{
...
void RGBController_MSIMotherboard162::DeviceUpdateMode()
{
    DeviceUpdateLEDs();
}

void RGBController_MSIMotherboard162::DeviceSaveMode()
{
     controller->Update(true);
}

void RGBController_MSIMotherboard162::SetupModes()
{
...
void RGBController_MSIMotherboard162::UpdateLed
    (
    int zone,
    int led
    )
...
void RGBController_MSIMotherboard162::SetupMode
    (
    const char      *name,
    MSI_MODE        mod,
    unsigned int    flags
...
void RGBController_MSIMotherboard162::GetDeviceConfig()
{
    MSI_MODE       mode;
    MSI_SPEED      speed;
