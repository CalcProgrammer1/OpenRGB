/*---------------------------------------------------------*\
| RGBController_MSIMotherboard185.cpp                       |
|                                                           |
...
RGBController_MSIMotherboard185::RGBController_MSIMotherboard185(MSIMotherboard185Controller* controller_ptr)
{
...
RGBController_MSIMotherboard185::~RGBController_MSIMotherboard185()
{
    Shutdown();
...
int RGBController_MSIMotherboard185::GetDeviceMode()
{
...
void RGBController_MSIMotherboard185::SetupZones()
{
    ...
    for(std::size_t zone_idx = 0; zone_idx < zones.size(); zone_idx++)
    {
        ...
        \*-------------------------------------------------*/
        else if(controller->GetSupportedDirectMode() == MSIMotherboard185Controller::DIRECT_MODE_ZONE_BASED)
        {
            zones[zone_idx].name                        = zd->name;
            zones[zone_idx].type                        = ZONE_TYPE_SINGLE;
...
void RGBController_MSIMotherboard185::DeviceConfigureZone(int zone_idx)
{
...
void RGBController_MSIMotherboard185::GetDeviceConfig()
{
