/*---------------------------------------------------------*\
| MSIMotherboard112Controller.cpp                           |
|                                                           |
...
MSIMotherboard112Controller::MSIMotherboard112Controller(hid_device* handle, const char* path, std::string dev_name)
{
    dev         = handle;
    location    = path;
    name        = dev_name;
...
MSIMotherboard112Controller::~MSIMotherboard112Controller()
{
    hid_close(dev);
}

void MSIMotherboard112Controller::SetMode
    (
    MSI_ZONE        zone,
    MSI_MODE        mode,
    MSI_SPEED       speed,
...
std::string MSIMotherboard112Controller::GetDeviceName()
{
    return name;
}

std::string MSIMotherboard112Controller::GetFWVersion()
{
...
std::string MSIMotherboard112Controller::GetDeviceLocation()
{
    return("HID: " + location);
}

std::string MSIMotherboard112Controller::GetSerial()
{
...
bool MSIMotherboard112Controller::ReadSettings()
{
    /*-----------------------------------------------------*\
...
bool MSIMotherboard112Controller::Update
    (
    bool save
    )
{
...
void MSIMotherboard112Controller::SetZoneColor
    (
    MSI_ZONE        zone,
    unsigned char   red1,
    unsigned char   grn1,
...
void MSIMotherboard112Controller::SetLedColor
    (
    MSI_ZONE        zone,
    unsigned char   red,
    unsigned char   grn,
...
ZoneData *MSIMotherboard112Controller::GetZoneData
    (
...
bool MSIMotherboard112Controller::ReadFwVersion()
{
...
MSI_MODE MSIMotherboard112Controller::GetMode()
{
    return (MSI_MODE)data.on_board_led.effect;
}

void MSIMotherboard112Controller::GetMode
    (
    MSI_ZONE        zone,
    MSI_MODE        &mode,
    MSI_SPEED       &speed,
...
void MSIMotherboard112Controller::SetDirectMode
    (
    bool mode
    )
{
...
size_t MSIMotherboard112Controller::GetMaxOnboardLeds()
{
