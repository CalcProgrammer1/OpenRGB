...
<context>
    ...
    <message>
        ...
        <translation>&lt;h2&gt;一部の内部デバイスが検出されない可能性があります：&lt;/h2&gt;&lt;p&gt;I2CまたはSMBusインターフェースの1つ以上が初期化に失敗しました。&lt;/p&gt;&lt;p&gt;&lt;b&gt;I2CまたはSMBusがない場合、RGB DRAMモジュール、一部のマザーボードのオンボードRGB照明、およびRGBグラフィックカードはOpenRGBで利用できません。&lt;/b&gt;&lt;/p&gt;&lt;h4&gt;これを修正する方法：&lt;/h4&gt;&lt;p&gt;Linuxでは、通常i2c-devモジュールが読み込まれていないことが原因です。&lt;/p&gt;&lt;p&gt;マザーボードに適したi2cドライバー（AMDシステムでは通常i2c-piix4、Intelシステムではi2c-i801）とともにi2c-devモジュールを読み込む必要があります。&lt;/p&gt;&lt;p&gt;このメッセージが繰り返し表示される場合は、&lt;a href=&apos;https://help.openrgb.org/&apos;&gt;help.openrgb.org&lt;/a&gt;で追加のトラブルシューティング手順をご覧ください。&lt;br&gt;&lt;/p&gt;&lt;h3&gt;デスクトップで内部RGBを使用していない場合は、このメッセージはあなたにとって重要ではありません。&lt;/h3&gt;</translation>
    </message>
    <message>
